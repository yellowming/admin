...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  watch: {
    pagination: {
      handler: function handler() {//console.log(this.pagination)
      },
      deep: true
    }
  },
  methods: {
    ...
    dialogFormSubmit: function dialogFormSubmit() {
      ...
      this.axios.post('user/add', this.dialogForm).then(function (Response) {
        ...
        _this.dialogFormReset();

        _this.getUsersFromApi();
      });
    },
    ...
    pa: function pa() {
      ...
      this.getUsersFromApi().then(function (Response) {
        _this2.userListLoading = false;
        _this2.userList = Response.data.success.data;
        _this2.totalUsers = Response.data.success.total;
      });
    },
